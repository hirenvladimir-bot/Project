...
#
# Generated by export_simulation on Sat Jun 06 12:04:22 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_sin.sh' script.

./blk_mem_gen_sin.sh -reset_run
...
./blk_mem_gen_sin.sh -noclean_files

For more information on the script, please type './blk_mem_gen_sin.sh -help'.
